...
public class InactiveMedicineAdapter extends RecyclerView.Adapter<InactiveMedicineAdapter.ViewHolder> {
    ...
    public InactiveMedicineAdapter(Context context, OnMedicineClickListener listener) {
...
//    }
    ...
    public void applyChanges(@NonNull InactiveMedicineAdapter.ViewHolder holder, @NonNull Medicine medicineDetails) {
